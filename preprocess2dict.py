...
with open('user2movie.pickle', 'wb') as f:
    pickle.dump(user2movie, f)

with open('movie2user.pickle', 'wb') as f:
    pickle.dump(movie2user, f)

with open('usermovie2rating.pickle', 'wb') as f:
    pickle.dump(usermovie2rating, f)

with open('usermovie2rating_test.pickle', 'wb') as f:
